...
if test "$PHP_PHIZ" != "no"; then
  ...
  PHP_NEW_EXTENSION(phiz, php_phiz.c phiz_str8.c phiz_carray.c src/ucode8.c src/str8_obj.c src/carray_obj.c src/tom_p.c phiz_exceptions.c, $ext_shared, ,$PHP_PHIZ_FLAGS)
