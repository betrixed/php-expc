...
if test "$PHP_PHIZ" != "no"; then
  ...
  PHP_NEW_EXTENSION(phiz, php_phiz.c phiz_str8.c phiz_cregx.c phiz_carray.c src/ucode8.c src/str8_obj.c src/carray_obj.c src/tom_p.c src/daytime.c phiz_exceptions.c phiz_daytime.c phiz_ctoml.c, $ext_shared, ,$PHP_PHIZ_FLAGS)
